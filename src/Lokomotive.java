...
public class Lokomotive {
		...
		if (this.lokStatus == STATUS_HAELT) {
			if (lokfuehrerName != null) {
				...
				if (gewicht <= zugkraftKg) {
					...
					System.out
							.println("Fehler: Lokomotive kann nicht losfahren, da die Waggons zu schwer sind. Es m�ssen Waggons abgekoppelt werden!");
				} // if else
	...
	public void ankoppelnGueter(Gueterwaggon g) {
		if (this.lokStatus == STATUS_HAELT) {
			...
			System.out
					.println("Fehler: Waggons k�nnen nur angekoppelt werden, wenn die Lok steht!");
		}
	}// ankoppelnGueter
	...
	public void abkoppelnGueter(Gueterwaggon g) {
		if (this.lokStatus == STATUS_HAELT) {
			...
			System.out
					.println("Fehler: Waggons k�nnen nur abgekoppelt werden, wenn die Lok steht!");
		}
